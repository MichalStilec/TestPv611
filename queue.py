...
print()
print(f"Prints the count of the elements in the queue: {queue.count()}")
print("Prints the whole queue: ", end="")
queue.printQueue()
print(f"Prints the element that was first in the queue: {queue.pop()}")
print("Prints the whole queue again: ", end="")
queue.printQueue()
print(f"Prints all elements and then removes them from the queue: {queue.popAll()}")
print(f"Prints again the count of the elements in the queue: {queue.count()}")
queue.printQueue() # This just checks if the queue is empty
